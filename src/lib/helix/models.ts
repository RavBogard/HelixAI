...
export interface HelixModel {
  ...
  instrument?: "guitar" | "bass"; // undefined = guitar (backward-compat), "bass" = bass amp/cab
}
...
export const AMP_MODELS: Record<string, HelixModel> = {
  ...
  // BASS AMP MODELS
  // ============================================================
  // HD2 model IDs follow naming convention — UNVERIFIED against real bass preset exports.
  // Confirm from real .hlx bass presets if loading incorrect amp in hardware.
  // Bass-appropriate defaults: lower Drive, higher Bass, moderate Mid for clarity.

  "SV Beast Nrm": {
    id: "HD2_AmpSVBeastNrm",
    name: "SV Beast Nrm",
    basedOn: "Ampeg SVT (Normal)",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["8x10 SVT AV", "4x10 Ampeg Pro"],
    ampFamily: "Ampeg" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.35, Bass: 0.60, Mid: 0.50, Treble: 0.45, ChVol: 0.7, Master: 0.55, Presence: 0.35, Sag: 0.50, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "SV Beast Brt": {
    id: "HD2_AmpSVBeastBrt",
    name: "SV Beast Brt",
    basedOn: "Ampeg SVT (Bright)",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["8x10 SVT AV", "4x10 Ampeg Pro"],
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.35, Bass: 0.55, Mid: 0.50, Treble: 0.50, ChVol: 0.7, Master: 0.55, Presence: 0.40, Sag: 0.50, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "Tuck n' Go": {
    id: "HD2_AmpTucknGo",
    name: "Tuck n' Go",
    ...
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["1x15 Ampeg B-15"],
    ampFamily: "Ampeg" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.30, Bass: 0.60, Mid: 0.55, Treble: 0.45, ChVol: 0.7, Master: 1.0, Presence: 0.30, Sag: 0.65, Hum: 0.15, Ripple: 0.15, Bias: 0.70, BiasX: 0.50 },
  },
  "Ampeg B15NF 66": {
    id: "HD2_AmpAmpegB15NF66",
    name: "Ampeg B15NF 66",
    basedOn: "Ampeg B-15NF Portaflex (1966)",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["1x15 Ampeg B-15"],
  ...
  "Ampeg SVT 50th": {
    id: "HD2_AmpAmpegSVT50th",
    name: "Ampeg SVT 50th",
    basedOn: "Ampeg Heritage 50th Anniversary SVT",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["8x10 SVT AV", "4x10 Ampeg Pro"],
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.40, Bass: 0.60, Mid: 0.50, Treble: 0.45, ChVol: 0.7, Master: 0.55, Presence: 0.35, Sag: 0.45, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "Ampeg SVT-4 Pro": {
    id: "HD2_AmpAmpegSVT4Pro",
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.30, Bass: 0.60, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.60 },
  },
  "Cali Bass": {
    id: "HD2_AmpCaliBass",
    name: "Cali Bass",
    ...
    ampCategory: "clean" as const,
    topology: "solid_state" as const,
    cabAffinity: ["6x10 Cali Power"],
    ampFamily: "Mesa" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.30, Bass: 0.55, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.60 },
  },
  "Cali 400 Ch1": {
    id: "HD2_AmpCali400Ch1",
    name: "Cali 400 Ch1",
    basedOn: "Mesa/Boogie Bass 400+ (Channel 1)",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["6x10 Cali Power", "4x10 Garden"],
    ampFamily: "Mesa" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.30, Bass: 0.55, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.55, Presence: 0.35, Sag: 0.50, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "Cali 400 Ch2": {
    id: "HD2_AmpCali400Ch2",
    name: "Cali 400 Ch2",
    basedOn: "Mesa/Boogie Bass 400+ (Channel 2)",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["6x10 Cali Power", "4x10 Garden"],
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.40, Bass: 0.55, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.55, Presence: 0.35, Sag: 0.50, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "G Cougar 800": {
    ...
    ampCategory: "clean" as const,
    topology: "solid_state" as const,
    cabAffinity: ["4x10 Garden", "8x10 SVT AV"],
    ampFamily: "Other" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.25, Bass: 0.55, Mid: 0.60, Treble: 0.55, ChVol: 0.7, Master: 0.60 },
  },
  "Woody Blue": {
    id: "HD2_AmpWoodyBlue",
    name: "Woody Blue",
    ...
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["2x15 Brute", "1x15 Ampeg B-15"],
    ampFamily: "Other" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.40, Bass: 0.60, Mid: 0.50, Treble: 0.45, ChVol: 0.7, Master: 1.0, Sag: 0.55, Hum: 0.15, Ripple: 0.15, Bias: 0.70, BiasX: 0.50 },
  },
  "Del Sol 300": {
    id: "HD2_AmpDelSol300",
    name: "Del Sol 300",
    ...
    ampCategory: "crunch" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["2x15 Brute", "8x10 SVT AV"],
    ampFamily: "Other" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.40, Bass: 0.60, Mid: 0.50, Treble: 0.45, ChVol: 0.7, Master: 0.55, Presence: 0.35, Sag: 0.50, Hum: 0.15, Ripple: 0.15, Bias: 0.70, BiasX: 0.50 },
  },
  "Busy One Ch1": {
    id: "HD2_AmpBusyOneCh1",
    name: "Busy One Ch1",
    basedOn: "Pearce BC-1 Preamp (Channel 1)",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "solid_state" as const,
    cabAffinity: ["4x10 Garden", "1x12 Epicenter"],
    ampFamily: "Other" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.25, Bass: 0.55, Mid: 0.60, Treble: 0.55, ChVol: 0.7, Master: 0.60 },
  ...
  "Busy One Ch2": {
    id: "HD2_AmpBusyOneCh2",
    name: "Busy One Ch2",
    basedOn: "Pearce BC-1 Preamp (Channel 2)",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "solid_state" as const,
    cabAffinity: ["4x10 Garden", "1x12 Epicenter"],
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.40, Bass: 0.55, Mid: 0.60, Treble: 0.55, ChVol: 0.7, Master: 0.60 },
  },
  "Busy One Jump": {
    id: "HD2_AmpBusyOneJump",
    name: "Busy One Jump",
    basedOn: "Pearce BC-1 Preamp (Jumped)",
    category: "crunch",
    ampCategory: "crunch" as const,
    topology: "solid_state" as const,
    cabAffinity: ["4x10 Garden", "1x12 Epicenter"],
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.35, Bass: 0.55, Mid: 0.60, Treble: 0.55, ChVol: 0.7, Master: 0.60 },
  },
  "Agua 51": {
    id: "HD2_AmpAgua51",
    name: "Agua 51",
    basedOn: "Aguilar DB 51",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["1x12 Epicenter", "4x10 Garden"],
    ampFamily: "Other" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.25, Bass: 0.55, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.60, Presence: 0.30, Sag: 0.55, Hum: 0.10, Ripple: 0.10, Bias: 0.65, BiasX: 0.50 },
  },
  "Agua 751": {
    id: "HD2_AmpAgua751",
    name: "Agua 751",
    basedOn: "Aguilar DB 751",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["1x12 Epicenter", "4x10 Garden"],
  ...
  "Agua Sledge": {
    ...
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.25, Bass: 0.55, Mid: 0.55, Treble: 0.50, ChVol: 0.7, Master: 0.60 },
  },
  "US Drip Bass": {
    id: "HD2_AmpUSDripBass",
    name: "US Drip Bass",
    basedOn: "Fender Bassman (Silverface)",
    category: "clean",
    ampCategory: "clean" as const,
    topology: "plate_fed" as const,
    cabAffinity: ["2x15 Dripman", "4x10 Tweed P10R"],
    ampFamily: "Fender" as AmpFamily,
    instrument: "bass",
    blockType: BLOCK_TYPES.AMP,
    defaultParams: { Drive: 0.35, Bass: 0.60, Mid: 0.50, Treble: 0.45, ChVol: 0.7, Master: 1.0, Presence: 0.35, Sag: 0.65, Hum: 0.15, Ripple: 0.15, Bias: 0.70, BiasX: 0.50 },
  },
};
...
export const CAB_MODELS: Record<string, HelixModel> = {
  ...
  // BASS CAB MODELS
  // HD2 model IDs follow naming convention — UNVERIFIED against real bass preset exports.
  // Bass-appropriate defaults: lower LowCut for sub content, lower HighCut to roll off harsh highs.
  "1x15 Ampeg B-15": { id: "HD2_CabMicIr_1x15AmpegB15", name: "1x15 Ampeg B-15", basedOn: "Ampeg B-15 1x15", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 6500.0, Position: 0.24, Angle: 0 } },
  "2x15 Brute": { id: "HD2_CabMicIr_2x15Brute", name: "2x15 Brute", basedOn: "Mesa/Boogie 2x15 EV", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 6500.0, Position: 0.24, Angle: 0 } },
  "4x10 Garden": { id: "HD2_CabMicIr_4x10Garden", name: "4x10 Garden", basedOn: "Eden D410XLT", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 7000.0, Position: 0.24, Angle: 0 } },
  "8x10 SVT AV": { id: "HD2_CabMicIr_8x10SVTAV", name: "8x10 SVT AV", basedOn: "Ampeg SVT Heritage 8x10", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 6500.0, Position: 0.24, Angle: 0 } },
  "1x12 Epicenter": { id: "HD2_CabMicIr_1x12Epicenter", name: "1x12 Epicenter", basedOn: "Epifani Ultralight 1x12", category: "medium", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 7000.0, Position: 0.24, Angle: 0 } },
  "4x10 Ampeg Pro": { id: "HD2_CabMicIr_4x10AmpegPro", name: "4x10 Ampeg Pro", basedOn: "Ampeg PR-410HLF", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 6500.0, Position: 0.24, Angle: 0 } },
  "2x15 Dripman": { id: "HD2_CabMicIr_2x15Dripman", name: "2x15 Dripman", basedOn: "Fender Bassman JBL D130 2x15", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 6500.0, Position: 0.24, Angle: 0 } },
  "6x10 Cali Power": { id: "HD2_CabMicIr_6x10CaliPower", name: "6x10 Cali Power", basedOn: "Mesa/Boogie PowerHouse 6x10", category: "large", instrument: "bass", blockType: BLOCK_TYPES.CAB_IN_SLOT, defaultParams: { Mic: 6, Distance: 1.0, Level: 0.0, LowCut: 40.0, HighCut: 7000.0, Position: 0.24, Angle: 0 } },
};
...
export const DELAY_MODELS: Record<string, HelixModel> = {
  ...
  "Cosmos Echo": { id: "HD2_DelayCosmosEcho", name: "Cosmos Echo", basedOn: "Roland RE-201 Space Echo", category: "tape", blockType: BLOCK_TYPES.DELAY, defaultParams: { Time: 0.375, Feedback: 0.35, Mix: 0.3, Wow: 0.3, Flutter: 0.3, Level: 0.0 }, paramOverrides: { Feedback: 0.28 } },
  ...
  "Adriatic Swell": { id: "HD2_DelaySwellAdriatic", name: "Adriatic Swell", basedOn: "Line 6 Original (Adriatic with Swell)", category: "ambient", blockType: BLOCK_TYPES.DELAY, defaultParams: { Time: 0.375, Feedback: 0.35, Mix: 0.3, RiseTime: 0.3, Level: 0.0 }, paramOverrides: { Feedback: 0.28 } },
  ...
  "Heliosphere": { id: "HD2_DelayHeliosphere", name: "Heliosphere", basedOn: "Line 6 Original Ambient Delay/Reverb", category: "ambient", blockType: BLOCK_TYPES.DELAY, defaultParams: { Time: 0.375, Feedback: 0.35, Mix: 0.3, Level: 0.0 }, paramOverrides: { Feedback: 0.28 } },
...
export const REVERB_MODELS: Record<string, HelixModel> = {
  ...
  "'63 Spring": { id: "HD2_Reverb63Spring", name: "'63 Spring", basedOn: "Fender '63 Spring Reverb", category: "spring", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.5, Mix: 0.3, Dwell: 0.5, PreDelay: 0, Level: 0.0, LowCut: 100, HighCut: 8000 } },
  "Glitz": { id: "HD2_ReverbGlitz", name: "Glitz", basedOn: "Line 6 Original Shimmer", category: "shimmer", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.7, Mix: 0.3, PreDelay: 0.03, Level: 0.0, LowCut: 100, HighCut: 10000 }, paramOverrides: { Mix: 0.22 } },
  ...
  "Plateaux": { id: "HD2_ReverbPlateaux", name: "Plateaux", basedOn: "Line 6 Original Shimmer Plate", category: "shimmer", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.7, Mix: 0.3, PreDelay: 0.03, Level: 0.0, LowCut: 100, HighCut: 10000 }, paramOverrides: { Mix: 0.22 } },
  "Double Tank": { id: "HD2_ReverbDoubleTank", name: "Double Tank", basedOn: "Line 6 Original Double Spring", category: "spring", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.5, Mix: 0.3, Dwell: 0.5, PreDelay: 0, Level: 0.0, LowCut: 100, HighCut: 8000 } },
  "Spring": { id: "HD2_ReverbSpring", name: "Spring", basedOn: "Line 6 Original Spring", category: "spring", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.5, Mix: 0.3, Dwell: 0.5, PreDelay: 0, Level: 0.0, LowCut: 100, HighCut: 8000 } },
  ...
  "Octo": { id: "HD2_ReverbOcto", name: "Octo", basedOn: "Line 6 Original Octave Reverb", category: "shimmer", blockType: BLOCK_TYPES.REVERB, defaultParams: { DecayTime: 0.7, Mix: 0.3, PreDelay: 0.03, Level: 0.0, LowCut: 100, HighCut: 10000 }, paramOverrides: { Mix: 0.22 } },
...
export const MODULATION_MODELS: Record<string, HelixModel> = {
  ...
  "Script Mod Phase": { id: "HD2_PhaserScriptModPhase", name: "Script Mod Phase", basedOn: "MXR Phase 90 (Script Logo)", category: "phaser", blockType: BLOCK_TYPES.MODULATION, defaultParams: { Rate: 0.07, Mix: 0.35, Level: 0.0, SyncSelect1: 6, TempoSync1: false } },
