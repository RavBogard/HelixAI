...
| 3 | HX Stomp Structure Rewrite | TBD | Not started | - |
...
---
*Roadmap updated: 2026-03-08 — Reordered: golden-preset rewrites first, dropped Stadium & Pod Go Fixes (superseded), validation after all builders correct*
